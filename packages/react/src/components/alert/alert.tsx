...
import type {AlertVariants} from "@sy-inc/styles";
import type {ReactNode} from "react";

import {alertVariants} from "@sy-inc/styles";
...
const AlertRoot = <E extends keyof React.JSX.IntrinsicElements = "div">({
  ...
  const alertContextValue = React.useMemo(() => ({slots, status}), [slots, status]);

  return (
    <AlertContext value={alertContextValue}>
