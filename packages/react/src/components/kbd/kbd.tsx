...
import type {KbdVariants} from "@sy-inc/styles";
import type {ReactNode} from "react";

import {kbdVariants} from "@sy-inc/styles";
...
const KbdRoot = <E extends keyof React.JSX.IntrinsicElements = "kbd">({
  ...
  const kbdContextValue = React.useMemo(() => ({slots}), [slots]);

  return (
    <KbdContext value={kbdContextValue}>
