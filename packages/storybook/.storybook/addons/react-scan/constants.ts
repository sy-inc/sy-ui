export const REACT_SCAN_ADDON_ID = "sy-inc-react-scan-addon";
export const REACT_SCAN_GLOBAL_TYPE_ID = "sy-inc-react-scan";
export const REACT_SCAN_PARAM_KEY = "sy-inc-react-scan";
