...
4. **Component Styling**: Ensuring CSS classes from @sy-ui/styles are properly applied in @sy-ui/react components
...
- **Global Styles**: `packages/storybook/styles/globals.css` (imports @sy-ui/styles)
