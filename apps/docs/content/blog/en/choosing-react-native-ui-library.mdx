...
description: "A practical framework for choosing a React Native UI library, and where SY INC Native fits."
date: "2026-05-12"
...
This guide explains how we think about that decision, and why SY INC Native is built the way it is.
...
SY INC Native takes the package approach:

- Install `sy-inc-native`.
...
SY INC Native is intentionally opinionated about the baseline:
...
SY INC Native is strongest when you want one ecosystem across product surfaces:

- Web product: [SY INC React](/docs/react/getting-started/quick-start)
- Mobile product: [SY INC Native](/docs/native/getting-started)
- Premium app surfaces: [SY INC Pro](https://sy-inc.com/pro)
- Design handoff: [SY INC Figma Kit V3](https://www.figma.com/community/file/1546526812159103429/sy-inc-figma-kit-v3)
...
## Where SY INC Native Is Different

SY INC Native is built specifically for React Native. It does not ask you to use web imports or CSS files that do not belong in mobile apps.
...
Do not use the SY INC web package or web-only event handlers in React Native screens.

SY INC Native uses `onPress`, `SyIncNativeProvider`, `GestureHandlerRootView`, Uniwind, and native overlay/portal patterns because those are the right abstractions for mobile.

## Recommendation

Choose SY INC Native when your team values design quality, maintainability, and ecosystem leverage. It is especially compelling if you already use SY INC on the web, work from Figma, or build with AI coding assistants.
