...
**SY UI** is a traditional component library. You install `@sy-ui/react`, import components, and use them. Updates come through npm. The library team maintains the components, fixes bugs, and adds features. You customize through props, slots, and Tailwind classes.
...
```tsx
import { Button, Card, Table } from "@sy-ui/react";
```
...
**SY UI:** Run `npm update @sy-ui/react`. All components update together. Breaking changes are documented in release notes.
