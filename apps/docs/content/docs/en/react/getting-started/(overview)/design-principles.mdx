...
description: Core principles that guide SY INC v3's design and development
icon: book
---

SY INC v3 follows 10 core principles that prioritize clarity, accessibility, customization, and developer experience.
...
<DocsImage
  src="https://assets.sy-inc.com/docs/emphasis.jpg"
  darkSrc="https://assets.sy-inc.com/docs/emphasis-dark.jpg"
...
```tsx
import { Tabs, TabList, Tab, TabPanel } from '@sy-inc/react';
...
import { Alert, AlertIcon, CardHeader, AccordionTrigger } from '@sy-inc/react';
...
Styles (`@sy-inc/styles`) are separate from logic (`@sy-inc/react`), enabling use with any framework or vanilla HTML. See [Tailwind Play example](https://play.tailwindcss.com/vMYXzKPyUx).
...
// Apply SY INC's BEM classes directly to any element
...
## Comparison with SY INC v2

| Aspect | SY INC v2 | SY INC v3 |
|--------|-----------|-----------|
