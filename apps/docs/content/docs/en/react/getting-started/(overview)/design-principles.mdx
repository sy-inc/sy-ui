...
description: Core principles that guide SY UI v3's design and development
icon: book
---

SY UI v3 follows 10 core principles that prioritize clarity, accessibility, customization, and developer experience.
...
<DocsImage
  src="https://assets.sy-ui.com/docs/emphasis.jpg"
  darkSrc="https://assets.sy-ui.com/docs/emphasis-dark.jpg"
...
// Apply SY UI's BEM classes directly to any element
...
## Comparison with SY UI v2

| Aspect | SY UI v2 | SY UI v3 |
|--------|-----------|-----------|
