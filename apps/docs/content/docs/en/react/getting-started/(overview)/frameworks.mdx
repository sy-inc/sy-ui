---
title: Frameworks
description: Integrate SY INC with your framework
icon: layers
---
...
### 2. Use your first SY INC component
    ...
    export default function HomePage() {
      return (
        <main className="flex min-h-screen items-center justify-center">
          <Button variant="tertiary">Hello SY INC</Button>
        </main>
      );
    }
    ```
...
<Callout>
  SY INC v3 does not require a provider. Components work directly after installation and style import.
</Callout>
...
import {isRTL} from '@sy-inc/react';
...
import {I18nProvider} from '@sy-inc/react';
