---
title: Frameworks
description: Integrate SY UI with your framework
icon: layers
---
...
### 2. Use your first SY UI component
    ...
    export default function HomePage() {
      return (
        <main className="flex min-h-screen items-center justify-center">
          <Button variant="tertiary">Hello SY UI</Button>
        </main>
      );
    }
    ```
...
<Callout>
  SY UI v3 does not require a provider. Components work directly after installation and style import.
</Callout>
