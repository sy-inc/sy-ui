---
title: LLMs.txt
description: Enable AI assistants like Claude, Cursor, and Windsurf to understand SY INC v3
---

We provide [LLMs.txt](https://llmstxt.org/) files to make SY INC v3 documentation accessible to AI coding assistants.

## Available Files

**Core documentation:**
- [/react/llms.txt](/react/llms.txt) — Quick reference index for React documentation
- [/react/llms-full.txt](/react/llms-full.txt) — Complete SY INC React documentation
...
```
Use SY INC React documentation from https://sy-inc.com/react/llms.txt
```
Or add to your project's `.claude` file for automatic loading.

**Cursor:** Use the `@Docs` feature:
```
@Docs https://sy-inc.com/react/llms-full.txt
```
...
```
https://sy-inc.com/react/llms.txt
```

**For component-specific documentation:**
```
https://sy-inc.com/react/llms-components.txt
```

**For patterns and best practices:**
```
https://sy-inc.com/react/llms-patterns.txt
```
