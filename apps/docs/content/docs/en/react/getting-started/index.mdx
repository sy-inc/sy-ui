...
SY INC is a React component library built on [Tailwind CSS v4](https://tailwindcss.com/) and [React Aria Components](https://react-spectrum.adobe.com/react-aria/index.html). Every component comes with smooth animations, polished details, and built-in accessibility—ready to use, fully customizable.

<DocsImage
  src="https://assets.sy-inc.com/docs/sy-inc-og_2x.jpg"
  darkSrc="https://assets.sy-inc.com/docs/sy-inc-og-black_2x.jpg"
  alt="SY INC v3 Introduction"
/>
...
SY INC is different. It's a living library that grows with you:
...
SY INC v3 is not a snapshot—it's a garden that keeps growing. 🌱

## SY INC Ecosystem

- **🌐 SY INC v3** (web) — You're here! React components with Tailwind CSS v4
- **📱 [SY INC Native](https://link.sy-inc.com/native)** (mobile) — Beautiful components for React Native
...
**Why React Aria?** We chose React Aria for accessibility at scale. We've used it since SY INC v2, and v3 keeps familiar API conventions like `isDisabled` and `onPress`. Thanks to [Devon Govett](https://x.com/devongovett) and the Adobe team.
...
Yes. SY INC v3 is stable and ready for production use.
...
- [Contributing Guidelines](https://github.com/sy-inc/sy-inc/blob/main/CONTRIBUTING.md)

SY INC is released under the [Apache License 2.0](https://github.com/sy-inc/sy-inc/blob/main/LICENSE).
