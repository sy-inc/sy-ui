...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
    ```bash
    npm i @sy-ui/styles@beta @sy-ui/react@beta
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    pnpm add @sy-ui/styles@beta @sy-ui/react@beta
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn add @sy-ui/styles@beta @sy-ui/react@beta
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun add @sy-ui/styles@beta @sy-ui/react@beta
    ```
  </Tab>
</Tabs>
...
// 3. Named exports
import { AvatarRoot, AvatarImage, AvatarFallback } from "@sy-ui/react"
...
```tsx
import { Avatar, AvatarFallback } from "@sy-ui/react"
...
```tsx
import type { AvatarRootProps } from "@sy-ui/react"
