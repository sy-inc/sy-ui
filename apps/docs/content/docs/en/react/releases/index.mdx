---
title: All Releases
description: All updates and changes to SY UI v3, including new features, fixes, and breaking changes.
---
...
Patch release: new `Text` compound component ported from SY UI Pro, docs theme selector, `min()`-capped border-radius tokens across 45+ component CSS files, reworked Table focus rings, and fixes for Checkbox, Autocomplete, Tooltip, and form field padding.

<VideoPlayer
  src="https://assets.sy-ui.com/videos/sy-ui-oss-3.0.4-4k.mp4"
  muted
/>
...
<DocsImage
  src="https://assets.sy-ui.com/docs/versions/rc-1-light@2x.jpg"
  darkSrc="https://assets.sy-ui.com/docs/versions/rc-1-dark@2x.jpg"
  alt="SY UI v3 RC 1"
...
<DocsImage
  src="https://assets.sy-ui.com/docs/versions/beta-8-light@2x.jpg"
  darkSrc="https://assets.sy-ui.com/docs/versions/beta-8-dark@2x.jpg"
  alt="SY UI v3 Beta 8"
...
<DocsImage
  src="https://assets.sy-ui.com/docs/versions/beta-7-light@2x.jpg"
  darkSrc="https://assets.sy-ui.com/docs/versions/beta-7-dark@2x.jpg"
  alt="SY UI v3 Beta 7"
...
<DocsImage
  src="https://assets.sy-ui.com/docs/versions/beta-6-light@2x.jpg"
  darkSrc="https://assets.sy-ui.com/docs/versions/beta-6-dark@2x.jpg"
  alt="SY UI v3 Beta 6"
...
<DocsImage
  src="https://assets.sy-ui.com/docs/versions/beta-4-light@2x.jpg"
  darkSrc="https://assets.sy-ui.com/docs/versions/beta-4-dark@2x.jpg"
  alt="SY UI v3 Beta 4"
...
<DocsImage
  src="https://assets.sy-ui.com/docs/versions/beta-3-light@2x.jpg"
  darkSrc="https://assets.sy-ui.com/docs/versions/beta-3-dark@2x.jpg"
  alt="SY UI v3 Beta 3"
...
<DocsImage
  src="https://assets.sy-ui.com/docs/versions/beta-2-light@2x.jpg"
  darkSrc="https://assets.sy-ui.com/docs/versions/beta-2-dark@2x.jpg"
  alt="SY UI v3 Beta 2"
...
- 🎨 **Showcases page** - Gallery of sites built with SY UI
...
SY UI v3 is now stable. Future releases follow a regular cycle:
...
Found an issue or want to contribute? Check out our [GitHub repository](https://github.com/sy-ui/sy-ui).
