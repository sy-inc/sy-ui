...
We're excited to introduce the **[Theme Builder](/themes)** - a powerful visual tool for creating and customizing SY UI themes. Build your perfect theme with real-time preview and export ready-to-use CSS.
...
Try it now at [v3.sy-ui.com/themes](/themes).
...
SY UI now provides direct exports from react-aria-components for easier access to primitives and utilities. These exports are particularly useful for [React Aria Framework setup](https://react-aria.adobe.com/frameworks).
...
- [Design System - Figma Kit V3 (updated)](https://www.figma.com/community/file/1546526812159103429/sy-ui-figma-kit-v3)
- [GitHub Repository](https://github.com/sy-ui/sy-ui)
- [GitHub PR #6121](https://github.com/sy-ui/sy-ui/pull/6121)
