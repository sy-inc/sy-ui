...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
    ```bash
    npm i @sy-ui/styles@alpha @sy-ui/react@alpha
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    pnpm add @sy-ui/styles@alpha @sy-ui/react@alpha
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn add @sy-ui/styles@alpha @sy-ui/react@alpha
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun add @sy-ui/styles@alpha @sy-ui/react@alpha
    ```
  </Tab>
</Tabs>
...
**Migration Steps:**
1. Import `SwitchGroup` separately: `import { Switch, SwitchGroup } from "@sy-ui/react"`
...
**Tabs Example:**
```tsx
import { TabsRoot, TabListContainer, TabList, Tab, TabIndicator, TabPanel } from "@sy-ui/react"
...
**Avatar Example:**
```tsx
import { Avatar, AvatarImage, AvatarFallback } from "@sy-ui/react"
...
- For Switch migrations, verify that `SwitchGroup` is imported: `import { Switch, SwitchGroup } from "@sy-ui/react"`
