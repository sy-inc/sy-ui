...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
    ```bash
    npm i @sy-inc/styles@alpha @sy-inc/react@alpha
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    pnpm add @sy-inc/styles@alpha @sy-inc/react@alpha
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn add @sy-inc/styles@alpha @sy-inc/react@alpha
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun add @sy-inc/styles@alpha @sy-inc/react@alpha
    ```
  </Tab>
</Tabs>
...
**Migration Steps:**
1. Import `SwitchGroup` separately: `import { Switch, SwitchGroup } from "@sy-inc/react"`
...
You have two options for using SY INC compound components:
...
**Tabs Example:**
```tsx
import { TabsRoot, TabListContainer, TabList, Tab, TabIndicator, TabPanel } from "@sy-inc/react"
...
**Avatar Example:**
```tsx
import { Avatar, AvatarImage, AvatarFallback } from "@sy-inc/react"
...
- For Switch migrations, verify that `SwitchGroup` is imported: `import { Switch, SwitchGroup } from "@sy-inc/react"`
...
4. Report issues at: [GitHub Issues](https://github.com/sy-inc/sy-inc/issues)
