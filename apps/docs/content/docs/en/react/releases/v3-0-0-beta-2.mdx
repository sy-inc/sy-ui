...
```tsx
// Before
import type { SelectContentProps } from "@sy-ui/react"

// After
import type { SelectPopoverProps } from "@sy-ui/react"
```
...
```tsx
// Before
import { SelectContent } from "@sy-ui/react"

// After
import { SelectPopover } from "@sy-ui/react"
```
