...
```tsx
// Before
import type { SelectContentProps } from "@sy-inc/react"

// After
import type { SelectPopoverProps } from "@sy-inc/react"
```
...
```tsx
// Before
import { SelectContent } from "@sy-inc/react"

// After
import { SelectPopover } from "@sy-inc/react"
```
...
- [GitHub PR #5885](https://github.com/sy-inc/sy-inc/pull/5885)
