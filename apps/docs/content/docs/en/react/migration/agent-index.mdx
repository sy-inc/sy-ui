...
description: Entry point for AI assistants helping migrate SY INC v2 to v3
index: false
---

For AI assistants: use this as the entry point when helping migrate SY INC v2 → v3.
