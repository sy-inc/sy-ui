...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
    ```bash
    npm uninstall @sy-ui/react @sy-ui/theme
    npm install @sy-ui/styles @sy-ui/react
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    pnpm remove @sy-ui/react @sy-ui/theme
    pnpm add @sy-ui/styles @sy-ui/react
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn remove @sy-ui/react @sy-ui/theme
    yarn add @sy-ui/styles @sy-ui/react
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun remove @sy-ui/react @sy-ui/theme
...
```js
// tailwind.config.js
const {sy-ui} = require("@sy-ui/react");
...
/* globals.css or main.css */
@import "tailwindcss";
@import "@sy-ui/styles"; /* [!code highlight]*/
```

<Callout type="warning">
  Import order matters! Always import `tailwindcss` before `@sy-ui/styles`.
</Callout>
...
import {Button, type ButtonProps} from "@sy-ui/react";

// Compound component types are properly exported
import {Checkbox, type CheckboxProps} from "@sy-ui/react";
...
- Update all component imports to `@sy-ui/react`
