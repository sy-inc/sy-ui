---
title: Agent Skills
description: Enable AI assistants to migrate SY UI v2 to v3
---

SY UI Migration Skills give your AI assistant comprehensive knowledge of SY UI v2 to v3 migration workflows, component guides, and best practices.
...
Skills are **automatically discovered** by your AI assistant, or call it directly using `/sy-ui-migration` command.

Simply ask your AI assistant to:
- Migrate components from SY UI v2 to v3
