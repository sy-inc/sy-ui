---
title: AGENTS.md
description: Download SY INC v2 to v3 migration docs for AI coding agents
---

Download SY INC v2 to v3 migration documentation directly into your project for AI assistants to reference.
...
```bash
npx sy-inc-cli@latest agents-md --migration
```

Or specify output file:

```bash
npx sy-inc-cli@latest agents-md --migration --output AGENTS.md
```

### What It Does

- Downloads migration docs to `.sy-inc-docs/migration/`
...
Migration docs are useful for any project migrating from SY INC v2 to v3. The target project needs:

- Tailwind CSS >= v4
- React >= 19.0.0 (for v3)
- `@sy-inc/react` or `@sy-inc/styles` (after migration)
