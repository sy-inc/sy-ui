---
title: AGENTS.md
description: Download SY UI v2 to v3 migration docs for AI coding agents
---

Download SY UI v2 to v3 migration documentation directly into your project for AI assistants to reference.
...
```bash
npx sy-ui-cli@latest agents-md --migration
```

Or specify output file:

```bash
npx sy-ui-cli@latest agents-md --migration --output AGENTS.md
```

### What It Does

- Downloads migration docs to `.sy-ui-docs/migration/`
...
Migration docs are useful for any project migrating from SY UI v2 to v3. The target project needs:
