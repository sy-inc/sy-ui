---
title: InputOTP
description: Migration guide for InputOTP from SY UI v2 to v3
---

<Callout type="info">
  Refer to the [v3 InputOTP documentation](/docs/react/components/input-otp) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from SY UI v2.
</Callout>
...
SY UI re-exports common regex patterns from the input-otp library for convenience:
