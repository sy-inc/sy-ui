---
title: User
description: Migration guide for User from SY UI v2 to v3
---

<Callout type="warning">
  The User component has been **removed** in SY UI v3. Compose user displays manually using Avatar and text elements with Tailwind CSS classes.
</Callout>
