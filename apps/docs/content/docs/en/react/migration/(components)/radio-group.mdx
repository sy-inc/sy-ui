---
title: RadioGroup
description: Migration guide for RadioGroup from SY UI v2 to v3
---

<Callout type="info">
  Refer to the [v3 RadioGroup documentation](/docs/react/components/radio-group) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from SY UI v2.
</Callout>
