---
title: Snippet
description: Migration guide for Snippet from SY UI v2 to v3
---

<Callout type="warning">
  The Snippet component has been **removed** in SY UI v3. Use native HTML elements with Tailwind CSS classes and implement copy functionality manually using the Clipboard API.
</Callout>
