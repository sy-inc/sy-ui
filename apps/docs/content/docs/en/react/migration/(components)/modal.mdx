---
title: Modal
description: Migration guide for Modal from SY UI v2 to v3
---

<Callout type="info">
  Refer to the [v3 Modal documentation](/docs/react/components/modal) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from SY UI v2.
</Callout>
