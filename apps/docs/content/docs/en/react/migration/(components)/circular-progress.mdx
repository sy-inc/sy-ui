...
description: Migration guide for CircularProgress from SY UI v2 to v3 (now ProgressCircle)
---

<Callout type="info">
  Refer to the [v3 ProgressCircle documentation](/docs/react/components/progress-circle) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from SY UI v2.
</Callout>
