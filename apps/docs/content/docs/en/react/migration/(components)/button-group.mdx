---
title: ButtonGroup
description: Migration guide for ButtonGroup from SY INC v2 to v3
---

<Callout type="info">
  Refer to the [v3 ButtonGroup documentation](/docs/react/components/button-group) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from SY INC v2.
</Callout>
...
```tsx
import { ButtonGroup, Button } from "@sy-inc/react";
...
**v2:** Imported from `@sy-inc/react`
**v3:** Imported from `@sy-inc/react` (same package, but unified import)
