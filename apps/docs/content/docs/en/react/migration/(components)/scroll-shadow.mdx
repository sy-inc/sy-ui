...
**v3:** Imported from `@sy-ui/react` unified package
...
- Update import from `@sy-ui/scroll-shadow` to `@sy-ui/react`
- Enhanced API with more configuration options
- Better shadow detection and visibility control
- Same orientation support (vertical / horizontal); import from `@sy-ui/react`
