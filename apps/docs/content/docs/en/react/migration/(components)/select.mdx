---
title: Select
description: Migration guide for Select from SY UI v2 to v3
---

<Callout type="info">
  Refer to the [v3 Select documentation](/docs/react/components/select) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from SY UI v2.
</Callout>
