---
title: Code
description: Migration guide for Code from SY UI v2 to v3
---

<Callout type="warning">
  The Code component has been **removed** in SY UI v3. Use native HTML `<code>` element with Tailwind CSS classes instead.
</Callout>
    ...
    export default function App() {
      return (
        <div className="space-y-4">
          <p>
            Install SY UI with <Code>npm install @sy-inc/react</Code>
          </p>
