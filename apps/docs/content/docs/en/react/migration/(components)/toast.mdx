---
title: Toast
description: Migration guide for Toast from SY UI v2 to v3
---

<Callout type="info">
  Refer to the [v3 Toast documentation](/docs/react/components/toast) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from SY UI v2.
</Callout>
