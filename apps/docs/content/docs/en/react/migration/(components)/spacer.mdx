---
title: Spacer
description: Migration guide for Spacer from SY UI v2 to v3
---

<Callout type="warning">
  The Spacer component has been **removed** in SY UI v3. Use Tailwind CSS margin utilities directly instead.
</Callout>
