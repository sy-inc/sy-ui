---
title: Spacer
description: Migration guide for Spacer from SY INC v2 to v3
---

<Callout type="warning">
  The Spacer component has been **removed** in SY INC v3. Use Tailwind CSS margin utilities directly instead.
</Callout>
...
**v2:** `<Spacer>` component from `@sy-inc/react`
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Spacer } from "@sy-inc/react";
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Spacer, Button } from "@sy-inc/react";
...
2. **Import Change**: Remove `import { Spacer } from "@sy-inc/react"`
...
1. **Remove Import**: Remove `Spacer` from `@sy-inc/react` imports
