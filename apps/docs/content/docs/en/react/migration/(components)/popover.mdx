---
title: Popover
description: Migration guide for Popover from SY INC v2 to v3
---

<Callout type="info">
  Refer to the [v3 Popover documentation](/docs/react/components/popover) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from SY INC v2.
</Callout>
...
```tsx
import { Popover, PopoverTrigger, PopoverContent, Button } from "@sy-inc/react";
...
```tsx
import { Popover, Button } from "@sy-inc/react";
