---
title: Dropdown
description: Migration guide for Dropdown from SY UI v2 to v3
---

<Callout type="info">
  Refer to the [v3 Dropdown documentation](/docs/react/components/dropdown) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from SY UI v2.
</Callout>
