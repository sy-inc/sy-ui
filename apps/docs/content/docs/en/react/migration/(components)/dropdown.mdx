---
title: Dropdown
description: Migration guide for Dropdown from SY INC v2 to v3
---

<Callout type="info">
  Refer to the [v3 Dropdown documentation](/docs/react/components/dropdown) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from SY INC v2.
</Callout>
...
```tsx
import { Dropdown, DropdownTrigger, DropdownMenu, DropdownItem, Button } from "@sy-inc/react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ...
    import { Label, Description, Kbd } from "@sy-inc/react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { Label, Kbd } from "@sy-inc/react";
