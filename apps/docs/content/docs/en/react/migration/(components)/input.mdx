---
title: Input
description: Migration guide for Input from SY INC v2 to v3
---

<Callout type="info">
  Refer to the [v3 Input documentation](/docs/react/components/input) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from SY INC v2.
</Callout>
...
```tsx
import { TextField, Label, Input, FieldError } from "@sy-inc/react";
