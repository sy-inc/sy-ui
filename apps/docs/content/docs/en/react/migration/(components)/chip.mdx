---
title: Chip
description: Migration guide for Chip from SY UI v2 to v3
---

<Callout type="info">
  Refer to the [v3 Chip documentation](/docs/react/components/chip) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from SY UI v2.
</Callout>
