---
title: Image
description: Migration guide for Image from SY UI v2 to v3
---

<Callout type="warning">
  The Image component has been **removed** in SY UI v3. Use native HTML `<img>` element or Next.js `Image` component with Tailwind CSS classes instead.
</Callout>
