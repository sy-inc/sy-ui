---
title: Image
description: Migration guide for Image from SY INC v2 to v3
---

<Callout type="warning">
  The Image component has been **removed** in SY INC v3. Use native HTML `<img>` element or Next.js `Image` component with Tailwind CSS classes instead.
</Callout>
...
**v2:** `<Image>` component from `@sy-inc/react`
...
```tsx
import { Image } from "@sy-inc/react";
...
2. **Import Change**: Remove `import { Image } from "@sy-inc/react"`
...
1. **Remove Import**: Remove `Image` from `@sy-inc/react` imports
