...
**v2:** `<Image>` component from `@sy-ui/react`  
...
2. **Import Change**: Remove `import { Image } from "@sy-ui/react"`
...
1. **Remove Import**: Remove `Image` from `@sy-ui/react` imports
