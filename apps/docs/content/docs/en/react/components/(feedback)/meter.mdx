...
```tsx
import { Meter, Label } from '@sy-inc/react';
```
...
The Meter component uses these CSS classes ([View source styles](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/meter.css)):
