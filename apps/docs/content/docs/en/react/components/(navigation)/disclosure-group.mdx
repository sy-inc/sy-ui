...
```tsx
import { DisclosureGroup } from '@sy-inc/react';
```
...
```tsx
import {DisclosureGroup, Disclosure} from '@sy-inc/react';
...
The DisclosureGroup component uses these CSS classes ([View source styles](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/disclosure-group.css)):
