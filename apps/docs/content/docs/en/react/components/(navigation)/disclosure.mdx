...
```tsx
import { Disclosure } from '@sy-inc/react';
```
...
The Disclosure component uses these CSS classes ([View source styles](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/disclosure.css)):
