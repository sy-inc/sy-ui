...
```tsx
import { Dropdown } from '@sy-inc/react';
```
...
```tsx
import { Dropdown, Button, Label, Description, Header, Kbd, Separator } from '@sy-inc/react';
...
The Dropdown component uses these CSS classes ([View source styles](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/dropdown.css)):
...
#### Menu Classes [!toc]
- `.menu` - Base menu container ([menu.css](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/menu.css))
  - `[data-slot="separator"]` - Separator elements within the menu

#### MenuItem Classes [!toc]
- `.menu-item` - Base menu item container ([menu-item.css](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/menu-item.css))
...
- `.menu-section` - Base menu section container ([menu-section.css](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/menu-section.css))
...
```tsx
import { Dropdown, Button, Label } from '@sy-inc/react';
...
```tsx
import { Dropdown, Button, Label, Header, Separator } from '@sy-inc/react';
