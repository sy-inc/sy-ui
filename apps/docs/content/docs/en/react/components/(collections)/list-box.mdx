...
The ListBox component uses these CSS classes ([View source styles](https://github.com/sy-ui/sy-ui/blob/v3/packages/styles/components/list-box.css)):
...
<ListBox aria-label="Users" selectionMode="single">
  ...
  <ListBox.Item id="2" textValue="Alice">
    <Label>Alice</Label>
    <Description>alice@sy-ui.com</Description>
  </ListBox.Item>
</ListBox>
```
