...
```tsx
import { ListBox } from '@sy-inc/react';
```
...
```tsx
import { ListBox, Label, Description, Header } from '@sy-inc/react';
...
The ListBox component uses these CSS classes ([View source styles](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/list-box.css)):
...
```tsx
import { ListBox, Label, Description } from '@sy-inc/react';
...
<ListBox aria-label="Users" selectionMode="single">
  ...
  <ListBox.Item id="2" textValue="Alice">
    <Label>Alice</Label>
    <Description>alice@sy-inc.com</Description>
  </ListBox.Item>
</ListBox>
```
...
```tsx
import { ListBox, Header, Separator } from '@sy-inc/react';
...
```tsx
import { ListBox, Selection } from '@sy-inc/react';
...
```tsx
import { ListBox, ListBoxItemIndicator } from '@sy-inc/react';
