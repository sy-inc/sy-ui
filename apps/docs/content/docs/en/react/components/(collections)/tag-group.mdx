...
```tsx
import { TagGroup } from '@sy-inc/react';
```
...
```tsx
import { TagGroup, Tag, Label, Description, ErrorMessage } from '@sy-inc/react';
...
The TagGroup component uses these CSS classes ([View source styles](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/tag-group.css) and [tag.css](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/tag.css)):
