...
The TagGroup component uses these CSS classes ([View source styles](https://github.com/sy-ui/sy-ui/blob/v3/packages/styles/components/tag-group.css) and [tag.css](https://github.com/sy-ui/sy-ui/blob/v3/packages/styles/components/tag.css)):
