...
```tsx
import { ErrorMessage } from '@sy-inc/react';
```
...
The ErrorMessage component uses these CSS classes ([View source styles](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/error-message.css)):
