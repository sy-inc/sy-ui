...
```tsx
import { Checkbox, Description, FieldError } from '@sy-inc/react';
...
The Checkbox component uses these CSS classes ([View source styles](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/checkbox.css)):
