...
SY UI follows the [BEM](https://getbem.com/) methodology for components that ship styles in `@sy-inc/styles`.
...
The Form component works seamlessly with SY UI's form field components:
