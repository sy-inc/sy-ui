...
```tsx
import { Description } from '@sy-inc/react';
```
...
```tsx
import {TextField, Label, Input, Description} from '@sy-inc/react';
...
The Description component uses these CSS classes ([View source styles](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/description.css)):
