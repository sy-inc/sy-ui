...
```tsx
import { CheckboxGroup, Checkbox, Label, Description } from '@sy-inc/react';
```
...
```tsx
import {CheckboxGroup, Checkbox, Label, Description, FieldError} from '@sy-inc/react';
...
The CheckboxGroup component uses these CSS classes ([View source styles](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/checkbox-group.css)):
