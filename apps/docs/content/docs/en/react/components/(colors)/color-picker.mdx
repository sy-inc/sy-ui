...
```tsx
import { ColorPicker, ColorArea, ColorSlider, ColorSwatch, Label } from '@sy-inc/react';
...
The ColorPicker component uses these CSS classes ([View source styles](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/color-picker.css)):
