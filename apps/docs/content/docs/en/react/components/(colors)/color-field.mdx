...
```tsx
import { ColorField, parseColor } from '@sy-inc/react';
```
...
```tsx
import {ColorField, Label, ColorSwatch, Description, FieldError, parseColor} from '@sy-inc/react';
...
- **ColorSwatch** - Color preview component from `@sy-inc/react`
...
```tsx
import {parseColor} from '@sy-inc/react';
