...
See [AvatarGroup](/docs/react/components/avatar-group) for counts, shared appearance, and grid layouts.
...
The Avatar component uses these CSS classes ([View source styles](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/avatar.css)):
