...
```tsx
import { Toast, toast } from '@sy-inc/react';
```
...
```tsx
import { Toast, Button, toast } from '@sy-inc/react';
...
The Toast component uses these CSS classes ([View source styles](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/toast.css)):
