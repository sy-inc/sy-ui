...
```tsx
import { Tooltip } from '@sy-inc/react';
```
...
```tsx
import { Tooltip, Button } from '@sy-inc/react';
...
The Tooltip component uses these CSS classes ([View source styles](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/tooltip.css)):
