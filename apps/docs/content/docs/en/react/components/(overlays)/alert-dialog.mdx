...
```tsx
import { AlertDialog } from "@sy-inc/react";
```
...
The AlertDialog component uses these CSS classes ([View source styles](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/alert-dialog.css)):
