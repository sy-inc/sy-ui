...
The ToggleButtonGroup component uses these CSS classes ([View source styles](https://github.com/sy-ui/sy-ui/blob/v3/packages/styles/components/toggle-button-group.css)):
