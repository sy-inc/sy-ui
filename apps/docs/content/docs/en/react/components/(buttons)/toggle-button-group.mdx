...
```tsx
import { ToggleButtonGroup, ToggleButton } from '@sy-inc/react';
```
...
The ToggleButtonGroup component uses these CSS classes ([View source styles](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/toggle-button-group.css)):
