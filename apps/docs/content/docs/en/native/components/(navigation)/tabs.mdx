...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-ui.com/docs/native/components/videos/tabs-docs-light.mp4"
  srcDark="https://assets.sy-ui.com/docs/native/components/videos/tabs-docs-dark.mp4"
/>
...
You can find more examples in the [GitHub repository](<https://github.com/sy-ui/sy-ui-native/blob/main/example/src/app/(home)/components/tabs.tsx>).
...
```tsx
import { useTabs } from 'sy-ui-native';
...
```tsx
import { useTabsMeasurements } from 'sy-ui-native';
...
```tsx
import { useTabsTrigger } from 'sy-ui-native';
