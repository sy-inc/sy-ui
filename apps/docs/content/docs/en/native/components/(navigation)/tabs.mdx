...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-inc.com/docs/native/components/videos/tabs-docs-light.mp4"
  srcDark="https://assets.sy-inc.com/docs/native/components/videos/tabs-docs-dark.mp4"
/>
...
You can find more examples in the [GitHub repository](<https://github.com/sy-inc/sy-inc-native/blob/main/example/src/app/(home)/components/tabs.tsx>).
...
```tsx
import { useTabs } from 'sy-inc-native';
...
```tsx
import { useTabsMeasurements } from 'sy-inc-native';
...
```tsx
import { useTabsTrigger } from 'sy-inc-native';
