...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-inc.com/docs/native/components/videos/accordion-docs-light.mp4"
  srcDark="https://assets.sy-inc.com/docs/native/components/videos/accordion-docs-dark-1.mp4"
/>

## Import

```tsx
import { Accordion } from 'sy-inc-native';
```
...
```tsx
import { Accordion, PressableFeedback } from 'sy-inc-native';
...
```tsx
import { Accordion, useThemeColor } from 'sy-inc-native';
...
You can find more examples in the [GitHub repository](https://github.com/sy-inc/sy-inc-native/blob/main/example/src/app/(home)/components/accordion.tsx).
...
```tsx
import { useAccordion } from 'sy-inc-native';
...
```tsx
import { useAccordionItem } from 'sy-inc-native';
...
```jsx
import { Accordion, AccordionLayoutTransition } from 'sy-inc-native';
