...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-ui.com/docs/native/components/videos/accordion-docs-light.mp4"
  srcDark="https://assets.sy-ui.com/docs/native/components/videos/accordion-docs-dark-1.mp4"
/>

## Import

```tsx
import { Accordion } from 'sy-ui-native';
```
...
```tsx
import { Accordion, PressableFeedback } from 'sy-ui-native';
...
```tsx
import { Accordion, useThemeColor } from 'sy-ui-native';
...
You can find more examples in the [GitHub repository](https://github.com/sy-ui/sy-ui-native/blob/main/example/src/app/(home)/components/accordion.tsx).
...
```tsx
import { useAccordion } from 'sy-ui-native';
...
```tsx
import { useAccordionItem } from 'sy-ui-native';
...
```jsx
import { Accordion, AccordionLayoutTransition } from 'sy-ui-native';
