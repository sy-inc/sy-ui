...
```tsx
import { ListGroup, PressableFeedback, Separator } from 'sy-ui-native';
...
import { ListGroup, Separator, useThemeColor } from 'sy-ui-native';
...
You can find more examples in the [GitHub repository](https://github.com/sy-ui/sy-ui-native/blob/main/example/src/app/(home)/components/list-group.tsx).
