...
```tsx
import type { MenuKey } from 'sy-ui-native';
import { Button, Menu, Separator } from 'sy-ui-native';
...
You can find more examples in the [GitHub repository](<https://github.com/sy-ui/sy-ui-native/blob/main/example/src/app/(home)/components/menu.tsx>).
...
```tsx
import { useMenu } from 'sy-ui-native';
...
```tsx
import { useMenuItem } from 'sy-ui-native';
...
```tsx
import { useMenuAnimation } from 'sy-ui-native';
...
```tsx
import { useSubMenu } from 'sy-ui-native';
