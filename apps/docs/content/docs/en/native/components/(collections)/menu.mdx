...
```tsx
import type { MenuKey } from 'sy-inc-native';
import { Button, Menu, Separator } from 'sy-inc-native';
...
You can find more examples in the [GitHub repository](<https://github.com/sy-inc/sy-inc-native/blob/main/example/src/app/(home)/components/menu.tsx>).
...
```tsx
import { useMenu } from 'sy-inc-native';
...
```tsx
import { useMenuItem } from 'sy-inc-native';
...
```tsx
import { useMenuAnimation } from 'sy-inc-native';
...
```tsx
import { useSubMenu } from 'sy-inc-native';
