...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-ui.com/docs/native/components/videos/scroll-shadow-docs-light.mp4"
  srcDark="https://assets.sy-ui.com/docs/native/components/videos/scoll-shadow-docs-dark.mp4.mp4"
/>

## Import

```tsx
import { ScrollShadow } from 'sy-ui-native';
```
...
```tsx
import { ScrollShadow, Surface } from 'sy-ui-native';
import { LinearGradient } from 'expo-linear-gradient';
...
You can find more examples in the [GitHub repository](https://github.com/sy-ui/sy-ui-native/blob/main/example/src/app/(home)/components/scroll-shadow.tsx).
