...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-inc.com/docs/native/components/videos/scroll-shadow-docs-light.mp4"
  srcDark="https://assets.sy-inc.com/docs/native/components/videos/scoll-shadow-docs-dark.mp4.mp4"
/>

## Import

```tsx
import { ScrollShadow } from 'sy-inc-native';
```
...
```tsx
import { ScrollShadow, Surface } from 'sy-inc-native';
import { LinearGradient } from 'expo-linear-gradient';
...
You can find more examples in the [GitHub repository](https://github.com/sy-inc/sy-inc-native/blob/main/example/src/app/(home)/components/scroll-shadow.tsx).
