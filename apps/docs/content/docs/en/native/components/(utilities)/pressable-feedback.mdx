...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-ui.com/docs/native/components/videos/pressable-feedback-docs-light.mp4"
  srcDark="https://assets.sy-ui.com/docs/native/components/videos/pressable-feedback-docs-dark.mp4"
/>
...
```tsx
import { PressableFeedback, Card, Button } from 'sy-ui-native';
  ...
  return (
    <PressableFeedback className="w-full aspect-square overflow-auto">
      <Card className="flex-1">
        <Image
          source={{
            uri: 'https://assets.sy-ui.com/docs/neo2.jpeg',
          }}
...
You can find more examples in the [GitHub repository](<https://github.com/sy-ui/sy-ui-native/blob/main/example/src/app/(home)/components/pressable-feedback.tsx>).
