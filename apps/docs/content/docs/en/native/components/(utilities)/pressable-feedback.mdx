...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-inc.com/docs/native/components/videos/pressable-feedback-docs-light.mp4"
  srcDark="https://assets.sy-inc.com/docs/native/components/videos/pressable-feedback-docs-dark.mp4"
/>
...
```tsx
import { PressableFeedback, Card, Button } from 'sy-inc-native';
  ...
  return (
    <PressableFeedback className="w-full aspect-square overflow-auto">
      <Card className="flex-1">
        <Image
          source={{
            uri: 'https://assets.sy-inc.com/docs/neo2.jpeg',
          }}
...
You can find more examples in the [GitHub repository](<https://github.com/sy-inc/sy-inc-native/blob/main/example/src/app/(home)/components/pressable-feedback.tsx>).
