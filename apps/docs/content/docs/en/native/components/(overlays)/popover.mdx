...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-inc.com/docs/native/components/videos/popover-docs-light.mp4"
  srcDark="https://assets.sy-inc.com/docs/native/components/videos/popover-docs-dark.mp4"
/>
...
import { Button, Popover, useThemeColor } from 'sy-inc-native';
...
You can find more examples in the [GitHub repository](https://github.com/sy-inc/sy-inc-native/blob/main/example/src/app/(home)/components/popover.tsx).
...
```tsx
import { usePopover } from 'sy-inc-native';
...
```tsx
import { usePopoverAnimation } from 'sy-inc-native';
