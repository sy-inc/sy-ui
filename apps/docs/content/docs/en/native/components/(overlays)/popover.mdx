...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-ui.com/docs/native/components/videos/popover-docs-light.mp4"
  srcDark="https://assets.sy-ui.com/docs/native/components/videos/popover-docs-dark.mp4"
/>
...
import { Button, Popover, useThemeColor } from 'sy-ui-native';
...
You can find more examples in the [GitHub repository](https://github.com/sy-ui/sy-ui-native/blob/main/example/src/app/(home)/components/popover.tsx).
...
```tsx
import { usePopover } from 'sy-ui-native';
...
```tsx
import { usePopoverAnimation } from 'sy-ui-native';
