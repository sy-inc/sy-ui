...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-ui.com/docs/native/components/videos/dialog-docs-light.mp4"
  srcDark="https://assets.sy-ui.com/docs/native/components/videos/dialog-docs-dark.mp4"
/>
...
You can find more examples in the [GitHub repository](https://github.com/sy-ui/sy-ui-native/blob/main/example/src/app/(home)/components/dialog.tsx).
