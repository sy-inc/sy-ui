...
```tsx
import { BottomSheet } from 'sy-inc-native';
```
...
See the full example with a sticky footer (`BottomSheetFooter`) in the [GitHub repository](<https://github.com/sy-inc/sy-inc-native/blob/main/example/src/components/bottom-sheet/scrollable-with-snap-points.tsx>).
...
```tsx
import { useBottomSheet, useBottomSheetAnimation } from 'sy-inc-native';
...
```tsx
import { BottomSheet, Input, useBottomSheetAwareHandlers } from 'sy-inc-native';
...
See full examples for [`Input`](<https://github.com/sy-inc/sy-inc-native/blob/main/example/src/components/bottom-sheet/with-text-input.tsx>) and [`InputOTP`](<https://github.com/sy-inc/sy-inc-native/blob/main/example/src/components/bottom-sheet/with-otp-input.tsx>) inside a bottom sheet.
...
You can find more examples in the [GitHub repository](https://github.com/sy-inc/sy-inc-native/blob/main/example/src/app/(home)/components/bottom-sheet.tsx).
