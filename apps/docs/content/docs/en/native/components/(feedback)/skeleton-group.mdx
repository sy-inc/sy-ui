...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-inc.com/docs/native/components/videos/skeleton-docs-light.mp4"
  srcDark="https://assets.sy-inc.com/docs/native/components/videos/skeleton-docs-dark.mp4"
/>

## Import

```tsx
import { SkeletonGroup } from 'sy-inc-native';
```
...
```tsx
import { Card, SkeletonGroup, Avatar } from 'sy-inc-native';
      ...
      <Card className="p-4">
        ...
        <SkeletonGroup.Item className="h-48 w-full rounded-lg">
          <View className="h-48 bg-surface-tertiary rounded-lg overflow-hidden">
            <Image
              source={{
                uri: 'https://assets.sy-inc.com/backgrounds/cards/car1.jpg',
              }}
...
You can find more examples in the [GitHub repository](https://github.com/sy-inc/sy-inc-native/blob/main/example/src/app/(home)/components/skeleton-group.tsx).
