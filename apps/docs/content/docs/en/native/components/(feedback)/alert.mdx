...
```tsx
import { Alert, Button, CloseButton } from 'sy-inc-native';
...
You can find more examples in the [GitHub repository](<https://github.com/sy-inc/sy-inc-native/blob/main/example/src/app/(home)/components/alert.tsx>).
...
```tsx
import { useAlert } from 'sy-inc-native';
