...
```tsx
import { Skeleton } from 'sy-inc-native';
```
...
```tsx
import { Avatar, Card, Skeleton } from 'sy-inc-native';
...
You can find more examples in the [GitHub repository](https://github.com/sy-inc/sy-inc-native/blob/main/example/src/app/(home)/components/skeleton.tsx).
