...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-inc.com/docs/native/components/videos/avatar-docs-light.mp4"
  srcDark="https://assets.sy-inc.com/docs/native/components/videos/avatar-docs-dark.mp4"
/>
...
You can find more examples in the [GitHub repository](https://github.com/sy-inc/sy-inc-native/blob/main/example/src/app/(home)/components/avatar.tsx).
...
```tsx
import { Avatar, useAvatar, Skeleton } from 'sy-inc-native';
