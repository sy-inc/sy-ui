...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-ui.com/docs/native/components/videos/button-docs-light.mp4"
  srcDark="https://assets.sy-ui.com/docs/native/components/videos/button-docs-dark.mp4"
/>
...
```tsx
import { Button, PressableFeedback } from 'sy-ui-native';
...
```tsx
import { Button, useThemeColor } from 'sy-ui-native';
...
You can find more examples in the [GitHub repository](<https://github.com/sy-ui/sy-ui-native/blob/main/example/src/app/(home)/components/button.tsx>).
...
```tsx
import { useButton } from 'sy-ui-native';
