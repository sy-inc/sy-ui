...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-inc.com/docs/native/components/videos/button-docs-light.mp4"
  srcDark="https://assets.sy-inc.com/docs/native/components/videos/button-docs-dark.mp4"
/>
...
```tsx
import { Button, PressableFeedback } from 'sy-inc-native';
...
```tsx
import { Button, useThemeColor } from 'sy-inc-native';
...
You can find more examples in the [GitHub repository](<https://github.com/sy-inc/sy-inc-native/blob/main/example/src/app/(home)/components/button.tsx>).
...
```tsx
import { useButton } from 'sy-inc-native';
