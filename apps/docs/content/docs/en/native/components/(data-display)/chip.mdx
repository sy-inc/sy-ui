...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-inc.com/docs/native/components/videos/chip-docs-light.mp4"
  srcDark="https://assets.sy-inc.com/docs/native/components/videos/chip-docs-dark.mp4"
/>

## Import

```tsx
import { Chip } from 'sy-inc-native';
```
...
You can find more examples in the [GitHub repository](https://github.com/sy-inc/sy-inc-native/blob/main/example/src/app/(home)/components/chip.tsx).
...
```tsx
import { useChip } from 'sy-inc-native';
