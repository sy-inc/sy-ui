...
```tsx
import { Label, Slider } from 'sy-ui-native';
...
You can find more examples in the [GitHub repository](<https://github.com/sy-ui/sy-ui-native/blob/main/example/src/app/(home)/components/slider.tsx>).
...
```tsx
import { useSlider } from 'sy-ui-native';
