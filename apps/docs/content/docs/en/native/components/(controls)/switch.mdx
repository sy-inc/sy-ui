...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-ui.com/docs/native/components/videos/switch-docs-light.mp4"
  srcDark="https://assets.sy-ui.com/docs/native/components/videos/switch-docs-dark.mp4"
/>
...
You can find more examples in the [GitHub repository](https://github.com/sy-ui/sy-ui-native/blob/main/example/src/app/(home)/components/switch.tsx).
...
```tsx
import { useSwitch } from 'sy-ui-native';
...
```tsx
import { Description, ControlField, Label } from 'sy-ui-native';
