...
```tsx
import { SearchField } from 'sy-ui-native';
```
...
```tsx
import { Description, Label, SearchField } from 'sy-ui-native';
...
You can find more examples in the [GitHub repository](<https://github.com/sy-ui/sy-ui-native/blob/main/example/src/app/(home)/components/search-field.tsx>).
...
```tsx
import { useSearchField } from 'sy-ui-native';
