...
```tsx
import { Description } from 'sy-inc-native';
```
...
You can find more examples in the [GitHub repository](<https://github.com/sy-inc/sy-inc-native/blob/main/example/src/app/(home)/components/description.tsx>).
