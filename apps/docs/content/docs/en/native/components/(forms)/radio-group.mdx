...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-inc.com/docs/native/components/videos/radio-group-docs-light.mp4"
  srcDark="https://assets.sy-inc.com/docs/native/components/videos/radio-group-docs-dark.mp4"
/>
...
```tsx
import { RadioGroup, Radio, Label, Description } from 'sy-inc-native';
...
```tsx
import { RadioGroup, Radio, Label } from 'sy-inc-native';
...
```tsx
import { RadioGroup, FieldError } from 'sy-inc-native';
...
You can find more examples in the [GitHub repository](<https://github.com/sy-inc/sy-inc-native/blob/main/example/src/app/(home)/components/radio-group.tsx>).
