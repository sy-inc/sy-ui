...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-ui.com/docs/native/components/videos/radio-group-docs-light.mp4"
  srcDark="https://assets.sy-ui.com/docs/native/components/videos/radio-group-docs-dark.mp4"
/>
...
```tsx
import { RadioGroup, Radio, Label, Description } from 'sy-ui-native';
...
```tsx
import { RadioGroup, Radio, Label } from 'sy-ui-native';
...
```tsx
import { RadioGroup, FieldError } from 'sy-ui-native';
...
You can find more examples in the [GitHub repository](<https://github.com/sy-ui/sy-ui-native/blob/main/example/src/app/(home)/components/radio-group.tsx>).
