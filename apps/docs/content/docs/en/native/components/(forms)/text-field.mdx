...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-ui.com/docs/native/components/videos/text-field-docs-light.mp4"
  srcDark="https://assets.sy-ui.com/docs/native/components/videos/text-field-docs-dark.mp4"
/>
...
You can find more examples in the [GitHub repository](<https://github.com/sy-ui/sy-ui-native/blob/main/example/src/app/(home)/components/text-field.tsx>).
...
```tsx
import { TextField, useTextField } from 'sy-ui-native';
