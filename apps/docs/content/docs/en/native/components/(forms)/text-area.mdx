...
```tsx
import { TextArea } from 'sy-ui-native';
```
...
```tsx
import { FieldError, Label, TextArea, TextField } from 'sy-ui-native';
...
```tsx
import { Label, TextArea, TextField } from 'sy-ui-native';
...
```tsx
import { Description, FieldError, Label, TextArea, TextField } from 'sy-ui-native';
...
You can find more examples in the [GitHub repository](https://github.com/sy-ui/sy-ui-native/blob/main/example/src/app/(home)/components/text-area.tsx).
