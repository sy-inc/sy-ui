...
```tsx
import { TextArea } from 'sy-inc-native';
```
...
```tsx
import { FieldError, Label, TextArea, TextField } from 'sy-inc-native';
...
```tsx
import { Label, TextArea, TextField } from 'sy-inc-native';
...
```tsx
import { Description, FieldError, Label, TextArea, TextField } from 'sy-inc-native';
...
You can find more examples in the [GitHub repository](https://github.com/sy-inc/sy-inc-native/blob/main/example/src/app/(home)/components/text-area.tsx).
