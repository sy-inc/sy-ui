...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-inc.com/docs/native/components/videos/select-docs-light.mp4"
  srcDark="https://assets.sy-inc.com/docs/native/components/videos/select-docs-dark.mp4"
/>
...
```tsx
import { Select, Separator } from 'sy-inc-native';
...
You can find more examples in the [GitHub repository](https://github.com/sy-inc/sy-inc-native/blob/main/example/src/app/(home)/components/select.tsx).
...
```tsx
import { useSelect } from 'sy-inc-native';
...
```tsx
import { useSelectAnimation } from 'sy-inc-native';
...
```tsx
import { useSelectItem } from 'sy-inc-native';
