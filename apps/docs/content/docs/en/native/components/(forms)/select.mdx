...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-ui.com/docs/native/components/videos/select-docs-light.mp4"
  srcDark="https://assets.sy-ui.com/docs/native/components/videos/select-docs-dark.mp4"
/>
...
```tsx
import { Select, Separator } from 'sy-ui-native';
...
You can find more examples in the [GitHub repository](https://github.com/sy-ui/sy-ui-native/blob/main/example/src/app/(home)/components/select.tsx).
...
```tsx
import { useSelect } from 'sy-ui-native';
...
```tsx
import { useSelectAnimation } from 'sy-ui-native';
...
```tsx
import { useSelectItem } from 'sy-ui-native';
