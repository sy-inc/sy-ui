...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-ui.com/docs/native/components/videos/checkbox-docs-light.mp4"
  srcDark="https://assets.sy-ui.com/docs/native/components/videos/checkbox-docs-dark.mp4"
/>

## Import

```tsx
import { Checkbox } from 'sy-ui-native';
```
...
You can find more examples in the [GitHub repository](<https://github.com/sy-ui/sy-ui-native/blob/main/example/src/app/(home)/components/checkbox.tsx>).
...
```tsx
import { useCheckbox } from 'sy-ui-native';
