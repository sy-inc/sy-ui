...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-ui.com/docs/native/components/videos/field-error-docs-light.mp4"
  srcDark="https://assets.sy-ui.com/docs/native/components/videos/field-error-docs-dark.mp4"
/>

## Import

```tsx
import { FieldError } from 'sy-ui-native';
```
...
```tsx
import { FieldError, Label, TextField } from 'sy-ui-native';
...
```tsx
import { Description, FieldError, Label, TextField } from 'sy-ui-native';
...
You can find more examples in the [GitHub repository](https://github.com/sy-ui/sy-ui-native/blob/main/example/src/app/(home)/components/field-error.tsx).
