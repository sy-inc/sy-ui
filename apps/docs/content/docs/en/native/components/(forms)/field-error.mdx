...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://assets.sy-inc.com/docs/native/components/videos/field-error-docs-light.mp4"
  srcDark="https://assets.sy-inc.com/docs/native/components/videos/field-error-docs-dark.mp4"
/>

## Import

```tsx
import { FieldError } from 'sy-inc-native';
```
...
```tsx
import { FieldError, Label, TextField } from 'sy-inc-native';
...
```tsx
import { Description, FieldError, Label, TextField } from 'sy-inc-native';
...
You can find more examples in the [GitHub repository](https://github.com/sy-inc/sy-inc-native/blob/main/example/src/app/(home)/components/field-error.tsx).
