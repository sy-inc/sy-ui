...
<NativeVideoPlayerView
  target="component"
  slug="input-otp"
  srcLight="https://assets.sy-inc.com/docs/native/components/videos/input-otp-docs-light.mp4"
  srcDark="https://assets.sy-inc.com/docs/native/components/videos/input-otp-docs-dark.mp4"
/>
...
```tsx
import { InputOTP, Label, Description } from "sy-inc-native";
...
**Related PR:** [#214](https://github.com/sy-inc/sy-inc-native/pull/214)
...
<NativeVideoPlayerView
  target="component"
  slug="label"
  srcLight="https://assets.sy-inc.com/docs/native/components/videos/label-docs-light.mp4"
  srcDark="https://assets.sy-inc.com/docs/native/components/videos/label-docs-dark.mp4"
/>
...
```tsx
import { Label, TextField } from "sy-inc-native";
...
<NativeVideoPlayerView
  target="component"
  slug="description"
  srcLight="https://assets.sy-inc.com/docs/native/components/videos/description-docs-light.mp4"
  srcDark="https://assets.sy-inc.com/docs/native/components/videos/description-docs-dark.mp4"
/>
...
```tsx
import { Description, TextField } from "sy-inc-native";
...
**Related PR:** [#207](https://github.com/sy-inc/sy-inc-native/pull/207)
...
**Related PR:** [#215](https://github.com/sy-inc/sy-inc-native/pull/215)
...
**Related PR:** [#218](https://github.com/sy-inc/sy-inc-native/pull/218)
...
**Related PR:** [#220](https://github.com/sy-inc/sy-inc-native/pull/220)

## API Enhancements

### SyIncNativeProvider devInfo Configuration

The `SyIncNativeProvider` component now supports `devInfo` configuration options for enhanced development experience.
...
**Related PR:** [#217](https://github.com/sy-inc/sy-inc-native/pull/217)
...
```tsx
import { Checkbox, Radio, TextField, InputOTP } from "sy-inc-native";
...
- **[Issue #93](https://github.com/sy-inc/sy-inc-native/issues/93)**: Fixed global border radius configuration not applying to Button component in sy-inc-native using Unwind. The Button component now properly respects border radius settings defined in the global theme configuration, ensuring consistent styling across the application.

- **[Issue #213](https://github.com/sy-inc/sy-inc-native/issues/213)**: Fixed Select controlled mode (`isOpen`) not working. The Select component now properly handles controlled state when the `isOpen` prop is provided, allowing developers to manage Select open/close state externally with predictable behavior.

**Related PRs:**

- [#218](https://github.com/sy-inc/sy-inc-native/pull/218)
- [#215](https://github.com/sy-inc/sy-inc-native/pull/215)
