...
<Tab value="npm">
  ```bash
  npm i sy-inc-native@beta
  ```
</Tab>
<Tab value="pnpm">
  ``` bash
  pnpm add sy-inc-native@beta
  ```
</Tab>
<Tab value="yarn">
  ```bash
  yarn add sy-inc-native@beta
  ```
</Tab>
<Tab value="bun">
  ```bash
  bun add sy-inc-native@beta
  ```
</Tab>
</Tabs>

<Callout type="info">
  **Using AI assistants?** Simply prompt "Hey Cursor, update SY INC Native to the latest version" and your AI assistant will automatically compare versions and apply the necessary changes. Learn more about the [SY INC Native MCP Server](/docs/native/getting-started/mcp-server).
</Callout>
...
<NativeVideoPlayerView
  target="component"
  slug="text-area"
  srcLight="https://assets.sy-inc.com/docs/native/components/videos/text-area-docs-light.mp4"
  srcDark="https://assets.sy-inc.com/docs/native/components/videos/text-area-docs-dark.mp4"
/>
...
```tsx
import { Description, Label, TextArea, TextField } from "sy-inc-native";
...
**Related PR:** [#254](https://github.com/sy-inc/sy-inc-native/pull/254)
...
<NativeVideoPlayerView
  target="component"
  slug="input"
  srcLight="https://assets.sy-inc.com/docs/native/components/videos/input-docs-light.mp4"
  srcDark="https://assets.sy-inc.com/docs/native/components/videos/input-docs-dark.mp4"
/>
...
```tsx
import { Description, Input, Label, TextField } from "sy-inc-native";
...
**Related PR:** [#247](https://github.com/sy-inc/sy-inc-native/pull/247)
...
<NativeVideoPlayerView
  target="component"
  slug="close-button"
  srcLight="https://assets.sy-inc.com/docs/native/components/videos/close-button-docs-light.mp4"
  srcDark="https://assets.sy-inc.com/docs/native/components/videos/close-button-docs-dark.mp4"
/>
...
```tsx
import { CloseButton } from "sy-inc-native";
...
**Related PR:** [#237](https://github.com/sy-inc/sy-inc-native/pull/237)
...
```tsx
import { Tabs } from "sy-inc-native";
...
**Related PR:** [#228](https://github.com/sy-inc/sy-inc-native/pull/228)
...
**Related PR:** [#235](https://github.com/sy-inc/sy-inc-native/pull/235)
...
**Related PR:** [#227](https://github.com/sy-inc/sy-inc-native/pull/227)
...
**Related PR:** [#243](https://github.com/sy-inc/sy-inc-native/pull/243)
...
**Related PR:** [#248](https://github.com/sy-inc/sy-inc-native/pull/248)
...
**Related PR:** [#263](https://github.com/sy-inc/sy-inc-native/pull/263)
...
**Related PR:** [#233](https://github.com/sy-inc/sy-inc-native/pull/233)
...
```tsx
import { buttonClassNames } from "sy-inc-native";
...
**Related PR:** [#252](https://github.com/sy-inc/sy-inc-native/pull/252)
...
**Related PR:** [#246](https://github.com/sy-inc/sy-inc-native/pull/246)
...
**Related PR:** [#236](https://github.com/sy-inc/sy-inc-native/pull/236)
...
```tsx
// Before
import { Divider } from "sy-inc-native";

<Divider />

// After
import { Separator } from "sy-inc-native";

<Separator />
```

**Related PR:** [#238](https://github.com/sy-inc/sy-inc-native/pull/238)
...
```tsx
// Before
import { FormField, ErrorView, TextField } from "sy-inc-native";
...
// After
import { ControlField, FieldError, Input, TextField } from "sy-inc-native";
...
```tsx
// Before
import { TextField } from "sy-inc-native";
...
// After
import { Input, TextField } from "sy-inc-native";
...
```tsx
import { ControlField, Description, FieldError, Input, Label, RadioGroup, TextField } from "sy-inc-native";
...
```tsx
// Before
import { Button, Dialog } from "sy-inc-native";
...
- **[Issue #181](https://github.com/sy-inc/sy-inc-native/issues/181)**: Fixed TextField error when inputting Chinese characters. The TextField component now properly handles multibyte characters and international input, ensuring smooth text entry for all languages including Chinese, Japanese, and Korean.

- **[Issue #219](https://github.com/sy-inc/sy-inc-native/issues/219)**: Fixed Button `childrenToString()` returning `"[object Object]"` for multiple children. The function now properly handles React elements and complex children structures, preventing stringification issues when rendering button content.

- **[Issue #232](https://github.com/sy-inc/sy-inc-native/issues/232)**: Fixed SyIncNativeProvider breaking with the recently released Uniwind Pro. The provider now properly handles Uniwind Pro compatibility, ensuring smooth integration with the latest Uniwind version.

- **[Issue #259](https://github.com/sy-inc/sy-inc-native/issues/259)**: Fixed BottomSheet issue where opening quickly and starting a meeting would prevent it from opening again. The refactored animation system resolves this issue by improving the entering/exiting animation logic.

- **[Issue #261](https://github.com/sy-inc/sy-inc-native/issues/261)**: Fixed `@gorhom/bottom-sheet` not being tree-shaken. The library now properly supports tree-shaking for unused dependencies.
...
- [#226](https://github.com/sy-inc/sy-inc-native/pull/226)
- [#239](https://github.com/sy-inc/sy-inc-native/pull/239)

## Links

- [Component Documentation](../components)
- [GitHub Repository](https://github.com/sy-inc/sy-inc-native)
