---
title: LLMs.txt
description: Enable AI assistants like Claude, Cursor, and Windsurf to understand SY UI Native
---

We provide [LLMs.txt](https://llmstxt.org/) files to make SY UI Native documentation accessible to AI coding assistants.

## Available Files

**Core documentation:**
- [/native/llms.txt](/native/llms.txt) — Quick reference index for Native documentation
- [/native/llms-full.txt](/native/llms-full.txt) — Complete SY UI Native documentation
...
```
Use SY UI Native documentation from https://sy-ui.com/native/llms.txt
```
Or add to your project's `.claude` file for automatic loading.

**Cursor:** Use the `@Docs` feature:
```
@Docs https://sy-ui.com/native/llms-full.txt
```
...
```
https://sy-ui.com/native/llms.txt
```

**For component-specific documentation:**
```
https://sy-ui.com/native/llms-components.txt
```

**For patterns and best practices:**
```
https://sy-ui.com/native/llms-patterns.txt
```
