...
SY INC Native follows 9 core principles that prioritize clarity, accessibility, customization, and developer experience.
...
```tsx
import { Button, Spinner } from 'sy-inc-native';
...
```tsx
import { Button, Chip, Avatar } from 'sy-inc-native';
