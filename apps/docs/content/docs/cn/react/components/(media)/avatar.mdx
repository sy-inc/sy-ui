...
计数、统一外观和网格布局请参阅 [AvatarGroup](/docs/react/components/avatar-group)。
...
Avatar 组件使用以下 CSS 类（[查看源码样式](https://github.com/sy-inc/sy-inc/blob/v3/packages/styles/components/avatar.css)）：
