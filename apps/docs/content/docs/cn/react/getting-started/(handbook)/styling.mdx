...
SY UI 的滚动插槽在组件 CSS 中使用 `@apply scrollbar`。对于你自己的溢出容器，可使用 `@sy-ui/styles` 提供的工具类：
...
所有组件的类名请查看 [@sy-ui/styles/components](https://github.com/sy-ui/sy-ui/tree/main/packages/styles/components)。
