...
import {ColorField, ColorSwatch, Description, Label, parseColor} from "@sy-inc/react";
...
export function CustomStyles() {
  ...
  return (
    <ColorField
      ...
      onChange={setColor}
    >
      <Label className="font-medium text-foreground">强调色</Label>
      <Description>应用于按钮、链接和焦点环。</Description>
      <ColorField.Group
