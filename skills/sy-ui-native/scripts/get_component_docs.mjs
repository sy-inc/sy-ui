#!/usr/bin/env node
/**
 * Get complete component documentation (MDX) for SY UI Native components.
 *
 * Usage:
...
const FALLBACK_BASE = "https://sy-ui.com";
  ...
  try {
    const options = {
      headers: {
        ...
        "User-Agent": "SY UI-Native-Skill/1.0",
      },
      method,
...
/**
 * Fetch MDX directly from v3.sy-ui.com as fallback.
 */
