#!/usr/bin/env node
/**
 * Get the main migration workflow guide (full or incremental) for SY INC v2 to v3.
 *
 * Usage:
  ...
  try {
    ...
    const title =
      migrationType === "incremental"
        ? "SY INC v2 to v3 Agent Migration Guide - Incremental Migration"
        : "SY INC v2 to v3 Agent Migration Guide - Full Migration";
