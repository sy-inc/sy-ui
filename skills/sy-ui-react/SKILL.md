...
# SY UI v3 React Development Guide

SY UI v3 is a component library built on **Tailwind CSS v4** and **React Aria Components**, providing accessible, customizable UI components for React applications.
...
**This guide is for SY UI v3 ONLY.** Do NOT apply v2 patterns — the provider, styling, and component API all changed:
...
- Button: `https://sy-ui.com/docs/react/components/button.mdx`
- Modal: `https://sy-ui.com/docs/react/components/modal.mdx`
- Form: `https://sy-ui.com/docs/react/components/form.mdx`

Getting started guides: use a concrete topic URL such as `https://sy-ui.com/docs/react/getting-started/quick-start.mdx`.
...
export default function RootLayout({
	...
	return (
		<html lang="en" suppressHydrationWarning>
			<body>
				{/* No Provider needed in SY UI v3! */}
				{children}
			</body>
		</html>
	);
...
1. **Tailwind CSS v4 is MANDATORY** - SY UI v3 will NOT work with Tailwind CSS v3
...
4. **Import Order Matters** - Always import Tailwind CSS before SY UI styles
...
SY UI v3 uses CSS variables with `oklch` color space:
...
For detailed theming, fetch: `https://sy-ui.com/docs/react/getting-started/theming.mdx`
