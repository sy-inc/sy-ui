#!/usr/bin/env node
/**
 * Get React/TypeScript source code implementation for SY UI v3 components.
 *
 * Usage:
...
const GITHUB_RAW_BASE = "https://raw.githubusercontent.com/sy-ui/sy-ui/refs/heads/v3";
    ...
    try {
      ...
      if (response.ok) {
        ...
        return {
          component,
          filePath: path,
          githubUrl: `https://github.com/sy-ui/sy-ui/blob/v3/${path}`,
          source: "fallback",
          sourceCode: content,
        };
      }
